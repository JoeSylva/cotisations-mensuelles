...
export default function MemberDashboard() {
  ...
  // Filtrer les 3 dernières cotisations par date
      ...
      <div className="flex h-screen bg-purple-100">
        ...
        <main className="flex-1 overflow-auto lg:ml-64">
          <div className="p-6 lg:p-8">
            {/* Header */}
            <div className="mb-8">
              <h1 className="text-3xl font-bold text-purple-900">Mon Espace</h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
              <Card className="lg:col-span-2 border-purple-200 shadow-md">
                <CardHeader className="bg-purple-50 border-b border-purple-200">
                  <CardTitle className="text-purple-800">Mon Profil</CardTitle>
                </CardHeader>
              ...
              <Card className="border-purple-200 shadow-md">
                <CardHeader className="bg-purple-50 border-b border-purple-200">
                  <CardTitle className="text-lg text-purple-800">Statut Adhésion</CardTitle>
                </CardHeader>
                <CardContent className="pt-6 space-y-4">
                  <div>
                    ...
                    <p
                      className={`text-lg font-bold ${
                        member?.statut === "actif" ? "text-green-600" : "text-red-600"
                      }`}
                    >
            ...
            <Card className="border-purple-200 shadow-md">
              <CardHeader className="bg-purple-50 border-b border-purple-200">
                <CardTitle className="text-purple-800">Mes Cotisations</CardTitle>
                <CardDescription className="text-purple-600">
                  {recentCotisations.length} dernière(s) cotisation(s)
                </CardDescription>
              </CardHeader>
